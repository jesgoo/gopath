		...
		<script type="text/javascript">
			...
			$(function() {
				$('#queryTable').datagrid( {
					title : '操作',
					//数据源
					url : '${ctx}/permission/user/query',
					//数据栏
					columns : [ [ {
							field : 'id',title : 'ID',width : perColW
					}, {
						field : 'username',title : '用户名',	width : perColW
					}, {
						field : 'realName',title : '姓名',width : perColW
					}, {
						field : 'roleNames',title : '角色',	width : perColW
					}, {
						field : 'departmentName',title : '部门',	width : perColW
					}, {
