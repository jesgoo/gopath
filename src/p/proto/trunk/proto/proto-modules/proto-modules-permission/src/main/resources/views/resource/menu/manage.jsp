		...
		<script type="text/javascript">
			...
			$(function(){
				$('#queryTable').treegrid({
					...
					rownumbers: true,
					collapsible:true,
					url:'${ctx}/permission/resource/menu/query',
					idField:'id',
					treeField:'name',
					columns:[[
						{field:'name',title:'菜单项名称',width:perColW},						
						{field:'value',title:'菜单项URL',width:perColW},
						{field:'rootName',title:'菜单名称',width:perColW},
